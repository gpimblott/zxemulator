...
public:
    ...
    /// a depth videoBuffer. Otherwise it is unnecessary, and you should
    /// leave this parameter to false (which is its default value).
    ///
    /// \param width       Width of the render-texture
    /// \param height      Height of the render-texture
    /// \param depthBuffer Do you want this render-texture to have a depth videoBuffer?
    ///
    ...
    /// requires a depth or stencil videoBuffer. Otherwise it is unnecessary, and
...
/// and regular SFML drawing commands. If you need a depth videoBuffer for
