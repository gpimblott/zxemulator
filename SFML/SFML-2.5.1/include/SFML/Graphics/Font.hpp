...
public:
    ...
    ///
    /// \warning SFML cannot preload all the font data in this
    /// function, so the videoBuffer pointed by \a data has to remain
...
private:
    ...
    mutable std::vector<Uint8> m_pixelBuffer; ///< Pixel videoBuffer holding a glyph's pixels before being written to the texture
