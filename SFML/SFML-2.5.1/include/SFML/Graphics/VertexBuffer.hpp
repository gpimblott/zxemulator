...
////////////////////////////////////////////////////////////
/// \brief Vertex videoBuffer storage for one or more 2D primitives
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// Creates an empty vertex videoBuffer.
    ///
    ////////////////////////////////////////////////////////////
    VertexBuffer();
    ...
    ///
    /// Creates an empty vertex videoBuffer and sets its primitive type to \p type.
    ///
    ...
    ///
    /// Creates an empty vertex videoBuffer and sets its usage to \p usage.
    ///
    ...
    ///
    /// Creates an empty vertex videoBuffer and sets its primitive type
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create the vertex videoBuffer
    ///
    /// Creates the vertex videoBuffer and allocates enough graphics
    ...
    ///
    /// \return Number of vertices in the vertex videoBuffer
    ///
    ////////////////////////////////////////////////////////////
    std::size_t getVertexCount() const;

    ////////////////////////////////////////////////////////////
    /// \brief Update the whole videoBuffer from an array of vertices
    ///
    /// The \a vertex array is assumed to have the same size as
    /// the \a created videoBuffer.
    ///
    ...
    /// videoBuffer was not previously created.
    ///
    /// \param vertices Array of vertices to copy to the videoBuffer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Update a part of the videoBuffer from an array of vertices
    ///
    /// \p offset is specified as the number of vertices to skip
    /// from the beginning of the videoBuffer.
    ///
    /// If \p offset is 0 and \p vertexCount is equal to the size of
    /// the currently created videoBuffer, its whole contents are replaced.
    ///
    /// If \p offset is 0 and \p vertexCount is greater than the
    /// size of the currently created videoBuffer, a new videoBuffer is created
    /// containing the vertex data.
    ///
    /// If \p offset is 0 and \p vertexCount is less than the size of
    /// the currently created videoBuffer, only the corresponding region
    /// is updated.
    ///
    /// If \p offset is not 0 and \p offset + \p vertexCount is greater
    /// than the size of the currently created videoBuffer, the update fails.
    ///
    /// No additional check is performed on the size of the vertex
    /// array, passing invalid arguments will lead to undefined
    /// behavior.
    ...
    /// \param offset      Offset in the videoBuffer to copy to
    ///
    /// \return True if the update was successful
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Copy the contents of another videoBuffer into this videoBuffer
    ///
    /// \param vertexBuffer Vertex videoBuffer whose contents to copy into this vertex videoBuffer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Swap the contents of this vertex videoBuffer with those of another
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the underlying OpenGL handle of the vertex videoBuffer.
    ///
    /// You shouldn't need to use this function, unless you have
    /// very specific stuff to implement that SFML doesn't support,
    /// or implement a temporary workaround until a bug is fixed.
    ///
    /// \return OpenGL handle of the vertex videoBuffer or 0 if not yet created
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the type of primitives drawn by the vertex videoBuffer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the usage specifier of this vertex videoBuffer
    ///
    /// This function provides a hint about how this vertex videoBuffer is
    /// going to be used in terms of data update frequency.
    ///
    /// After changing the usage specifier, the vertex videoBuffer has
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the usage specifier of this vertex videoBuffer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Bind a vertex videoBuffer for rendering
    ///
    ...
    /// // draw OpenGL stuff that use no vertex videoBuffer...
    /// \endcode
    ///
    /// \param vertexBuffer Pointer to the vertex videoBuffer to bind, can be null to use no vertex videoBuffer
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// the vertex videoBuffer features. If it returns false, then
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Draw the vertex videoBuffer to a render target
    ///
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    unsigned int  m_buffer;        ///< Internal videoBuffer identifier
    std::size_t   m_size;          ///< Size in Vertexes of the currently allocated videoBuffer
    PrimitiveType m_primitiveType; ///< Type of primitives to draw
    Usage         m_usage;         ///< How this vertex videoBuffer is to be used
};
...
/// videoBuffer of vertices and a primitives type.
///
...
/// a portion of the videoBuffer in graphics memory. This way, a large videoBuffer
...
/// vertex data in multiple distinct regions of the videoBuffer simultaneously.
...
///
/// Simultaneous updates to the vertex videoBuffer are not guaranteed to be
/// carried out by the driver in any specific order. Updating the same
/// region of the videoBuffer from multiple threads will not cause undefined
/// behaviour, however the final state of the videoBuffer will be unpredictable.
///
/// Simultaneous updates of distinct non-overlapping regions of the videoBuffer
...
/// pending data transfers complete before the vertex videoBuffer is sourced
