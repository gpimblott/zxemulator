...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Load the sound videoBuffer from a file
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Load the sound videoBuffer from a file in memory
    ///
    /// See the documentation of sf::InputSoundFile for the list
    /// of supported formats.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Load the sound videoBuffer from a custom stream
    ///
    /// See the documentation of sf::InputSoundFile for the list
    /// of supported formats.
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Load the sound videoBuffer from an array of audio samples
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Save the sound videoBuffer to an audio file
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the array of audio samples stored in the videoBuffer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the number of samples stored in the videoBuffer
    ///
    ...
    ///
    /// \see getChannelCount, getDurationInMicroseconds
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \see getSampleRate, getDurationInMicroseconds
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Update the internal videoBuffer with the cached audio samples
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Add a sound to the list of sounds that use this videoBuffer
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Remove a sound from the list of sounds that use this videoBuffer
    ///
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    unsigned int       m_buffer;   ///< OpenAL videoBuffer identifier
    std::vector<Int16> m_samples;  ///< Samples videoBuffer
    Time               m_duration; ///< Sound duration
    mutable SoundList  m_sounds;   ///< List of sounds that are using this videoBuffer
};
...
/// \ingroup audio
///
/// A sound videoBuffer holds the data of a sound, which is
...
/// a sf::Texture.
///
/// A sound videoBuffer can be loaded from a file (see loadFromFile()
...
/// of a sound videoBuffer and change the way it is played without actually
...
/// copy the videoBuffer that it uses, it only keeps a reference to it.
...
/// Usage example:
/// \code
/// // Declare a new sound videoBuffer
/// sf::SoundBuffer videoBuffer;
///
/// // Load it from a file
/// if (!videoBuffer.loadFromFile("sound.wav"))
/// {
///     // error...
/// }
///
/// // Create a sound source and bind it to the videoBuffer
/// sf::Sound sound1;
/// sound1.setBuffer(videoBuffer);
///
/// // Play the sound
/// sound1.play();
///
/// // Create another sound source bound to the same videoBuffer
/// sf::Sound sound2;
/// sound2.setBuffer(videoBuffer);
///
