...
public:
    ...
    /// continuously, the \a data videoBuffer must remain accessible until
    /// the sf::Music object loads a new music or is destroyed. That is,
    /// you can't deallocate the videoBuffer right after calling this function.
    ///
    ...
    /// [0, Dur) and (0, Dur-offset] respectively, where Dur is the value returned by getDurationInMicroseconds().
...
private:
    ...
    std::vector<Int16> m_samples;  ///< Temporary videoBuffer of samples
...
/// memory videoBuffer) must remain valid for the lifetime of the
/// sf::Music object.
///
