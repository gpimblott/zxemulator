...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Fill a new videoBuffer with audio samples, and append
    ///        it to the playing queue
    ///
    /// This function is called as soon as a videoBuffer has been fully
    /// consumed; it fills it again and inserts it back into the
    /// playing queue.
    ///
    /// \param bufferNum Number of the videoBuffer to fill (in [0, BufferCount])
    ...
    Int64         m_bufferSeeks[BufferCount]; ///< If videoBuffer is an "end videoBuffer", holds next seek position, else NoLoop. For play offset calculation.
};
