...
public:
    ...
    /// Be careful to use a videoBuffer which is large enough for
...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    std::vector<char> m_buffer; ///< Temporary videoBuffer holding the received data in Receive(Packet)
};
...
/// char videoBuffer[1024];
/// std::size_t received = 0;
/// sf::IpAddress sender;
/// unsigned short port;
/// socket.receive(videoBuffer, sizeof(videoBuffer), received, sender, port);
/// std::cout << sender.ToString() << " said: " << videoBuffer << std::endl;
///
/// // ----- The server -----
///
