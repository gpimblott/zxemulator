...
struct ContextSettings
{
    ...
    ///
    /// \param depth        Depth videoBuffer bits
    /// \param stencil      Stencil videoBuffer bits
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    unsigned int depthBits;         ///< Bits of the depth videoBuffer
    unsigned int stencilBits;       ///< Bits of the stencil videoBuffer
