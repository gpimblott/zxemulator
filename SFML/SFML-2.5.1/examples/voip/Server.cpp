...
private:
    ...
    {
        // We have reached the end of the videoBuffer and all audio data have been played: we can stop playback
        ...
        // Copy samples into a local videoBuffer to avoid synchronization problems
    ...
    void receiveLoop()
    {
        while (!m_hasFinished)
        {
            ...
            if (id == audioData)
            {
                // Extract audio samples from the packet, and append it to our samples videoBuffer
