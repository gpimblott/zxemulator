...
int main()
{
    ...
    // Staging videoBuffer for our terrain data that we will upload to our VertexBuffer
    ...
    else
    {
        ...
        // Resize the staging videoBuffer to be able to hold all the terrain geometry
...
/// the vertex videoBuffer when done.
///
////////////////////////////////////////////////////////////
void processWorkItem(std::vector<sf::Vertex>& vertices, const WorkItem& workItem)
{
    ...
    // Copy the resulting geometry from our thread-local videoBuffer into the target videoBuffer
