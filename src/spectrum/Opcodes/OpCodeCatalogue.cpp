...
#include "instructions/OutOpcodes.h"
 ...
 *
 * NB : This is not optimal as we have to scan through each provider.  It would be
 * faster to build a master list of all opcodes and their functions
 *
