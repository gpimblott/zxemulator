...
#define VIDEO_PIXEL_START 0x4000    // Start of the video videoBuffer in the memory map
...
private:
    ...
    void printBits(std::string msg, size_t const size, void const * const ptr) const;
...
public:
    ...
    emulator_types::byte *getBuffer() const {
        return videoBuffer;
    };
